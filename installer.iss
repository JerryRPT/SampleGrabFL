...
Source: "build\SampleGrab_artefacts\Release\VST3\SampleGrab.vst3\*"; DestDir: "{commoncf64}\VST3\SampleGrab.vst3\"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Filename: "cmd.exe"; Parameters: "/C python -m pip install --upgrade -r ""{commonappdata}\jerryrpt\SampleGrab\requirements.txt"""; Flags: runhidden waituntilterminated
...
; Deno is yt-dlp's recommended JavaScript runtime for full YouTube support
Filename: "winget.exe"; Parameters: "install -e --id DenoLand.Deno --accept-source-agreements --accept-package-agreements"; Flags: runhidden waituntilterminated
